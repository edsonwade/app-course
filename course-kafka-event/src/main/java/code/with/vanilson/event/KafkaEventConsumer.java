...
import code.with.vanilson.config.ConsumerConfig;
...
public class KafkaEventConsumer {
    ...
    private static final Properties props = ConsumerConfig.getKafkaProducerProperties();

    private KafkaEventConsumer() {
        throw new AssertionError("This class cannot be instantiated");
    }

    public static void recieveMessge() {
    ...
    public static void pollMessages(KafkaConsumer<String, String> consumers) {
        try {
            ...
            consumers.subscribe(List.of("twitter-topic"));
            // O consumidor Kafka lerá as mensagens do tópico Kafka chamado "demo_java" indefinidamente.
