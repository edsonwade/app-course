-- -- Drop existing sequences and tables with CASCADE
-- DROP SEQUENCE IF EXISTS public.events_id_seq CASCADE;
-- DROP SEQUENCE IF EXISTS public.organizers_id_seq CASCADE;
-- DROP SEQUENCE IF EXISTS public.products_id_seq CASCADE;
-- DROP SEQUENCE IF EXISTS public.venues_id_seq CASCADE;
...
ALTER TABLE public.events
    OWNER TO spring_boot_course_24;
...
ALTER TABLE public.organizers_id_seq
    OWNER TO spring_boot_course_24;
...
ALTER TABLE public.venues_id_seq
    OWNER TO spring_boot_course_24;
...
ALTER TABLE ONLY public.organizers
    ALTER COLUMN id SET DEFAULT nextval('public.organizers_id_seq'::regclass);

ALTER TABLE ONLY public.products
    ALTER COLUMN id SET DEFAULT nextval('public.products_id_seq'::regclass);

ALTER TABLE ONLY public.venues
    ALTER COLUMN id SET DEFAULT nextval('public.venues_id_seq'::regclass);
